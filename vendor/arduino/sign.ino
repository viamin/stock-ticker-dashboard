...
// #define PIXEL_COUNT 40 // Length of the strings in pixels. I am using a 1 meter long strings that have 60 LEDs per meter.
#define PIXEL_COUNT 274 // Length of the strings in pixels.
...
void inline serialPollRX()
{
  ...
  if (UCSR0A & _BV(RXC0))
  {                       // If there is a byte ready in the recieve buffer
